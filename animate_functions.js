...
function timedFunctionCreateDivToHoldQuestion() {
    setTimeout(function(){const newItem = $('<div class="expand"><span class = "questionPlace"></span><input id="answer-question" placeholder="Your answer here..." type="text"><button id ="submit-button">submit</button></div>');
    $('body').append(newItem)}, 390);
}
function timedFunctionCGetRidOfDiv() {
    setTimeout(function(){$('.expand').remove()}, 500);
}
...
function timedFunctionExpandDiv() {
    setTimeout(function(){ $('.expand').addClass('expandNow')}, 400);
};

function timedFunctionShrinkDiv() {
    setTimeout(function(){ $('.expand').removeClass('expandNow')}, 100);
};
...
function timedFunctionPlaceQuestion(newItem) {
    setTimeout(function(){
        ...
        questionField.append(newItem)}, 600);
    };
